...
from tradeDataClean.positions.strategies.leading_stock_arbitrage_backtest.criteria.buy_conditions import criteria_volume_health
...
def test_real_db():
    ...
    try:
        ...
        while curr_dt <= end_dt:
            ...
            if in_window:
                ok, reason, data = criteria_volume_health.check(strategy, code, name, curr_dt)
                if ok:
                    print(f"[PASS] {curr_dt}: {reason}")
